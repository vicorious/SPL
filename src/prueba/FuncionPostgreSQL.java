 ...
 *   <h3>Descripcion :</h3>  
 *   
 *    Clase que encapsula una funcion en postgre
 *    
 *   */
@Funcion(nombre = "add")
public class FuncionPostgreSQL 
{
	@Parametro(tipoparametro = TipoParametro.IN, tipodato = TipoElementoDB.INTEGER, orden = 2)
	private int parametroentrada;
	
	@Parametro(tipoparametro = TipoParametro.IN, tipodato = TipoElementoDB.INTEGER, orden = 3)
	private int parametroentrada2;
	...
	/**
	 * Getter
	 * @return: parametro de entrada de la funcion
	 */
	...
	/**
	 * Getter
	 * @return: parametro de entrada 2 de la funcion
	 */
	public int getParametroentrada2() 
	{
		return parametroentrada2;
	}

	/**
	 * Setter
	 * @param parametroentrada2: parametroentrada2 a asignar
	 */
	public void setParametroentrada2(int parametroentrada2) 
	{
		this.parametroentrada2 = parametroentrada2;
	}
